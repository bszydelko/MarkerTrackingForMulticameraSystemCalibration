...
void drawInfo(Mat& frame, int seqNum, int frameNum, const Point2d& detected, const Point& predicted)
{
	...
	//frame num, seq num
	putText(frame, "cam: " + to_string(seqNum+1), Point(1,30), font,1, Scalar(0, 0, 0), 3);
	putText(frame, "cam: " + to_string(seqNum+1), Point(1,30), font,1, Scalar(255, 255, 255), 1);

	putText(frame, "frame: " + to_string(frameNum+1), Point(1, 60), font, 1, Scalar(0, 0, 0),3);
	putText(frame, "frame: " + to_string(frameNum+1), Point(1, 60), font, 1, Scalar(255, 255, 255), 1);
	//detected
